...
public class EmployeeIntegrationTest {
  ...
  public void testRetrievalAll() throws Exception {
    ...
    mockMvc.perform(get(employeeUrl)
        ...
        .andExpect(jsonPath("$.data[0].photo").value("https://robohash.org/employee170"))
        .andExpect(jsonPath("$.data[0].fullName").value("David Gahan"))
        .andExpect(jsonPath("$.data[0].position").value("Backend"))
        .andExpect(jsonPath("$.data[0].admission").value(admissionDate.toString()))
        .andExpect(jsonPath("$.data[0].phone").value("77912345678"))
        .andExpect(jsonPath("$.data[1].id").exists())
        .andExpect(jsonPath("$.data[1].photo").value("https://robohash.org/employee170"))
        .andExpect(jsonPath("$.data[1].fullName").value("Martin Gore"))
        .andExpect(jsonPath("$.data[1].position").value("Frontend"))
        .andExpect(jsonPath("$.data[1].admission").value(admissionDate.toString()))
        .andExpect(jsonPath("$.data[1].phone").value("77987654321"))
        .andExpect(jsonPath("$.data[2].id").exists())
        .andExpect(jsonPath("$.data[2].photo").value("https://robohash.org/employee170"))
        .andExpect(jsonPath("$.data[2].fullName").value("Andrew Fletcher"))
        .andExpect(jsonPath("$.data[2].position").value("UX Designer"))
        .andExpect(jsonPath("$.data[2].admission").value(admissionDate.toString()))
        .andExpect(jsonPath("$.data[2].phone").value("77987653210"));
  }
