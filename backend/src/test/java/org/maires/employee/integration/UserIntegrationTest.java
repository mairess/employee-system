...
public class UserIntegrationTest {
  ...
  public void testRetrievalAll() throws Exception {
    ...
    mockMvc.perform(get(userUrl)
        ...
        .andExpect(jsonPath("$.data[1].photo").value("https://robohash.org/179.106.168.38.png"))
        .andExpect(jsonPath("$.data[1].fullName").value("Ermenegildo Fagundes"))
        .andExpect(jsonPath("$.data[1].username").value("gildo"))
        .andExpect(jsonPath("$.data[1].email").value("gildo@example.com"))
        .andExpect(jsonPath("$.data[1].role").value("USER"))
        .andExpect(jsonPath("$.data[2].id").exists())
        .andExpect(jsonPath("$.data[2].photo").value("https://robohash.org/179.106.168.48.png"))
        .andExpect(jsonPath("$.data[2].fullName").value("Gilmar de Castro"))
        .andExpect(jsonPath("$.data[2].username").value("gilmar"))
        .andExpect(jsonPath("$.data[2].email").value("gilmar@example.com"))
